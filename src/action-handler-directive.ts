...
customElements.define('action-handler-bmw-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
    const body = document.body;
    if (body.querySelector('action-handler-bmw-card')) {
        return body.querySelector('action-handler-bmw-card') as ActionHandler;
    }

    const actionhandler = document.createElement('action-handler-bmw-card');
